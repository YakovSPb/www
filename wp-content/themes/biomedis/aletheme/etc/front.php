...
function ale_enqueue_styles() {
	...
	wp_register_style( 'font_awesome_css', THEME_URL . '/css/font-awesome.min.css', array(), ALETHEME_THEME_VERSION, 'all');
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'vkcomments', 'https://vk.com/js/api/openapi.js?159', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
